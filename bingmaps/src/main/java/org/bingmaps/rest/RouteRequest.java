...
public class RouteRequest {
	...
	private int _travelMode = TravelMode.Transit;
	...
	private String _routeAttributes = "ra=routePath,transitStops";
	...
	public String toString(){
		...
		if(_travelMode == TravelMode.Transit && _avoidTypes != null && _avoidTypes.length > 0){
			sb.append("&avoid=");
		...
		if(_travelMode == TravelMode.Transit){
			sb.append("&"+this._routeAttributes);
